...
export class RestaurantResolver {
    ...
    async createRestaurant(
        ...
        const result = await firstValueFrom(
            this.restaurantClient.send<ICreateRestaurantResponse>(
    ...
    async updateResaurant(
        ...
        const result = await firstValueFrom(
            this.restaurantClient.send<IUpdateRestaurantResponse>(
    ...
    async deleteRestaurant(
        ...
        const result = await firstValueFrom(
            this.restaurantClient.send<IDeleteRestaurantResponse>(
                { cmd: 'delete_restaurant' },
                data,
            ),
        );
        if (result.status !== HttpStatus.OK) {
    ...
    async getRestaurantList(
        ...
        const result = await firstValueFrom(
            this.restaurantClient.send<IRestaurantListResponse>(
    ...
    async getRestaurantById(@Args('id', { type: () => Int }) id: number) {
        const result = await firstValueFrom(
            this.restaurantClient.send<IGetRestaurantByIdResult>(
    ...
    async rateRestaurant(
        ...
        const result = await firstValueFrom(
            this.restaurantClient.send<IRate>({ cmd: 'rate_restaurant' }, data),
        );
        if (result.status !== HttpStatus.OK) {
            throw new HttpException(
                { message: result.message, errors: result.errors },
